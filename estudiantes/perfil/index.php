...
<div class="container">
  ...
  <ul class="nav nav-tabs" id="perfilEstudianteTab" role="tablist">
    <li class="nav-item" role="presentation">
      <button class="nav-link active" id="perfil-tab" data-bs-toggle="tab" data-bs-target="#perfil-tab-pane" type="button" role="tab" aria-controls="perfil-tab-pane" aria-selected="true">Perfil del estudiante</button>
    </li>
    <li class="nav-item" role="presentation">
  ...
  <div class="tab-content" id="perfilEstudianteTab">
        ...
        <div class="car-body pt-4 pe-4 pb-4 ps-4 border-0">
          <form id="formPerfil" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-12 col-md-6">
              ...
              <?php if ($user['foto']): ?>
                <img id="img-preview" src="<?php echo getUploadUrl('estudiante/' . $user['foto']); ?>" alt="Foto de perfil" class="img-thumbnail rounded-pill mb-2" style="max-width: 125px;">
              <?php else: ?>
                <img id="img-preview" src="<?php echo getUploadUrl('estudiante/default.png'); ?>" alt="Foto de perfil" class="img-thumbnail rounded-pill mb-2" style="max-width: 125px;">
              <?php endif; ?>
