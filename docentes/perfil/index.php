...
<div class="container">
  ...
  <div class="tab-content" id="perfilDocenteTabContent">
        ...
        <div class="car-body pt-4 pe-4 pb-4 ps-4 border-0">
          <form id="formPerfil" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-12 col-md-6">
              ...
              <?php if ($user['foto']): ?>
                <img id="img-preview" src="<?php echo getUploadUrl('docente/' . $user['foto']); ?>" alt="Foto de perfil" class="img-thumbnail rounded-pill mb-2" style="max-width: 125px;">
              <?php else: ?>
                <img id="img-preview" src="<?php echo getUploadUrl('docente/default.png'); ?>" alt="Foto de perfil" class="img-thumbnail rounded-pill mb-2" style="max-width: 125px;">
              <?php endif; ?>
